	...
	<section id="left-side">
		...
		<div class="content">
			...
			<h1 class="text-intro opacity-0">Dustin Horning<br>Software Engineer/DevOps<br>
				Best viewed on desktop, then and click on the right half... </h1>

			<h2 class="text-intro opacity-0">PHP, Laravel, Javascript, Vue, AWS, Linux</h2>
			...
			<nav>
				<ul>
					...
					<li>
						...
						<a href="https://dustinhorningblog.wordpress.com" target="_blank"><i class="fa fa-wordpress fa-3x"></i></a>
						<span style='margin-right: 40px'></span>
